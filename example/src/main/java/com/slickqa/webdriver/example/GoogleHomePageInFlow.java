 ...
 */
public class GoogleHomePageInFlow implements InFlow {
    ...
    @Override
    public void completePage(WebDriverWrapper browser, Object context) throws Exception {
        // no default completing of page
    }
